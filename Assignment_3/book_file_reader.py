...
if __name__ == '__main__':
    ...
    book_paths_with_language_and_start_line_mark = [
        ...
        ('romeo_and_juliet_book/romeo_and_juliet_french.txt', 'french', 'quelque restriction.'),
        ('romeo_and_juliet_book/romeo_and_juliet_german.txt', 'german', 'http://gutenberg2000.de erreichbar.')
    ]

    words_list = read_text_to_word_list(*book_paths_with_language_and_start_line_mark[1])
